    ...
    return (
        <div className="min-h-screen bg-slate-50 text-gray-900 p-6 relative overflow-hidden flex flex-col justify-center items-center">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-20 left-20 w-64 h-64 bg-primary-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
            ...
            <div className="max-w-5xl mx-auto relative z-10 w-full">
                <div className="text-center mb-12">
                    <h1 className="text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary-600 to-purple-600">
                        Nhà Giả Kim AI
                    </h1>
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center justify-center mb-12">
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-xl w-full md:w-1/3 hover:shadow-2xl transition-shadow bg-gradient-to-b from-white to-gray-50">
                        ...
                        <input
                            ...
                            className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all shadow-sm"
                        />
                    </div>
                ...
                <div className="text-center mb-16">
                    <button
                        ...
                        className={`group relative px-10 py-5 bg-gradient-to-r from-primary-600 to-purple-600 rounded-full font-bold text-xl text-white shadow-xl hover:shadow-purple-500/40 transition-all transform hover:-translate-y-1 active:scale-95 ${loading ? 'opacity-70 cursor-wait' : ''
                            }`}
                    >
                        {loading ? (
                    ...
                    {error && (
                        <div className="mt-4 p-4 bg-red-100 text-red-600 rounded-xl inline-block animate-shake">
                ...
                {result && (
                    <div className="animate-fade-in-up bg-white/90 backdrop-blur-xl rounded-[2.5rem] p-0 border border-white shadow-2xl relative overflow-hidden ring-1 ring-gray-100">
                        {/* Result Glow */}
                        <div
                ...
                {showMicroscope && result && result.moleculeStructure && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
                        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl h-[80vh] flex flex-col overflow-hidden relative animate-scale-in">
...
// Add styles/animations manually since we're in a component
