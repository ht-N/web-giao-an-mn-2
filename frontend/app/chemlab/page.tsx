...
const Home = () => {
    ...
    return (
        <div className="min-h-screen">
            {/* Hero Section */}
            <section className="relative bg-gradient-to-br from-blue-600 via-primary to-purple-700 py-24 px-4 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <Link
                            href="/chemlab/explore"
                            className="group inline-flex items-center gap-2 bg-white text-primary font-bold px-10 py-5 rounded-xl shadow-2xl hover:shadow-white/20 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1"
                        >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {stats.map((stat, index) => (
                            <div key={index} className="text-center group hover:scale-110 transition-transform duration-300">
                                <div className="flex justify-center mb-2 text-primary group-hover:text-primary/80">
                                    {stat.icon}
                                </div>
            ...
            {/* Benefits Section */}
            <section className="bg-gradient-to-br from-primary/5 via-blue-50 to-purple-50 py-24 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-5xl font-bold text-gray-900 mb-4">
                            Lợi Ích Vượt Trội
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {benefits.map((benefit, index) => (
                            <div
                                key={index}
                                className="flex gap-6 bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 group hover:border-primary/50"
                            >
            ...
            {/* CTA Section */}
            <section className="relative bg-gradient-to-r from-primary via-blue-600 to-purple-600 py-24 px-4 overflow-hidden">
                <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                        <Link
                            href="/chemlab/explore"
                            className="group inline-flex items-center gap-2 bg-white text-primary font-bold px-10 py-5 rounded-xl shadow-2xl hover:shadow-white/30 transition-all duration-300 transform hover:scale-105"
                        >
                            <FlaskConical className="w-6 h-6 group-hover:rotate-12 transition-transform" />
                            Khám Phá Ngay
                        </Link>
