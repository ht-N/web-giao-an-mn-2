...
const About = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
            ...
            {/* Story Section */}
            <section className="bg-gradient-to-br from-primary/10 via-blue-50 to-purple-50 py-24 px-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="bg-gradient-to-r from-primary to-blue-600 p-10 rounded-2xl shadow-xl text-white text-center">
            ...
            <section className="bg-gradient-to-b from-slate-50 to-white py-24 px-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mt-16 text-center bg-gradient-to-r from-primary to-purple-600 p-12 rounded-2xl shadow-xl">
